...
**Note**: If you prefer a zero-installation option that works immediately, skip to Tool 2 (asciified API) below — it requires no setup and works in any terminal with curl.
